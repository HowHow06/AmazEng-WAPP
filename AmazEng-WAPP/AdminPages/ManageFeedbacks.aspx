        ...
        <div class="row align-items-center justify-content-between">
            <div class="col col-md-6 col-lg-3 col-xl-4">
                <div class="input-group me-2 me-lg-3 fmxw-400">
                    ...
                    <asp:TextBox ID="txtSearch" runat="server" class="form-control" placeholder="Search issuer name, email, idiom" OnTextChanged="txtSearch_TextChanged" />
                </div>
            </div>
    ...
    <asp:UpdatePanel ID="updatePanelGrid" runat="server">
        <ContentTemplate>
            <div class="card card-body border-0 shadow table-wrapper table-responsive">
                <asp:GridView ID="GridFeedbacks"
                    runat="server"
                    ItemType="AmazEng_WAPP.Models.Feedback"
                    DataKeyNames="Id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Idiom ">
                            <ItemTemplate>
                                <%#: Item.Idiom.Name %>
                            </ItemTemplate>
                        </asp:TemplateField>
